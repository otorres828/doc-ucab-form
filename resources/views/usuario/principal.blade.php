        ...
        <div class=" text-gray-700 py-10">
            <div class="grid md:grid-flow-col  px-7 sm:px-16 md:px-10 lg:px-28 ">
                <div class=" md:w-1/4  ">
                    <div class="max-w-md md:float-left md:text-left leading-loose tracking-tight md:sticky md:top-0">
                        <div style="height:30rem "
                            ...
                            @foreach ($categoriasSistema as $documento)
                                <a href="{{ route('sistema_show', $documento->slug) }}">
                                    <div
                ...
                <div class="md:ml-6 w-full md:w-3/4 ">
                    <blockquote>
                        <div
                            class="mt-10 bg-white mb-10 max-w-2xl mx-auto px-4 py-8 shadow-lg dark:bg-dark-600 lg:flex lg:items-center">
                            ...
                            <p class="mb-0 lg:ml-4">
                                <strong>Advertencia</strong> Estás navegando por la documentación del <span
                                    class="font-bold text-green-700">Manual de Usuario </span>
                                ucab-form, te aconsejamos leer detalladamente para hacer un buen uso del mismo.
                            </p>
                        </div>
                    </blockquote>
                    <div class=" leading-loose tracking-tight">
                        <h1 class="py-3 font-bold break-normal text-3xl md:text-5xl">Manual de Usuario</h1>
                        <div class="prose md:prose-lg lg:prose-xl text-justify">
                            En este apartado encontraras todo lo referente al manual de usuario
                        </div>
                        <ul>
                            @foreach ($categorias as $documento)
                                <li>
                                    <a href="{{ route('usuario_show', $documento->slug) }}">{{ $documento->name }}</a>
                                </li>
                            @endforeach
                        </ul>
                    </div>
