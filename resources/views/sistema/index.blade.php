...
@section('content_header')
    <h1>Lista de Documentos Manual de Sistema</h1>
@stop
...
@section('content')
    <div class="container mx-auto">
        <x-alert />
        <div class="mb-3">
            <a class="btn btn-primary " href="{{ route('manual.sistema.create') }}">Crear Documento</a>
        </div>
        <div class="pb-4">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            ...
                                            <a class="dropdown-item"
                                                href="{{ route('manual.sistema.edit', $anuncio) }}">Editar</a>
                                            <form class="destroy" action="{{ route('manual.sistema.destroy', $anuncio->id) }}"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
